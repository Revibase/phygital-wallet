...
export type Plugin =
  ...
  | { __kind: "Groups"; fields: readonly [Groups] };
...
export type PluginArgs =
  ...
  | { __kind: "Groups"; fields: readonly [GroupsArgs] };
...
export function getPluginEncoder(): Encoder<PluginArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    [
      "Groups",
      getStructEncoder([["fields", getTupleEncoder([getGroupsEncoder()])]]),
    ],
  ]);
}
...
export function getPluginDecoder(): Decoder<Plugin> {
  return getDiscriminatedUnionDecoder([
    ...
    [
      "Groups",
      getStructDecoder([["fields", getTupleDecoder([getGroupsDecoder()])]]),
    ],
  ]);
}
