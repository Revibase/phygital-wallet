...
export function getConfigEncoder(): FixedSizeEncoder<ConfigArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["verifiers", getArrayEncoder(getAddressEncoder(), { size: 8 })],
      ["verifierCount", getU8Encoder()],
      ["bump", getU8Encoder()],
...
export function getConfigDecoder(): FixedSizeDecoder<Config> {
  return getStructDecoder([
    ...
    ["verifiers", getArrayDecoder(getAddressDecoder(), { size: 8 })],
    ["verifierCount", getU8Decoder()],
    ["bump", getU8Decoder()],
