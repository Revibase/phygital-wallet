/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 91a8f59c77becad144a014a0999dd038)
// Runtime types generated with workerd@1.20260722.1 2025-07-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	NEXT_PUBLIC_APP_URL: "https://app.revibase.com";
	NEXTJS_ENV: string;
	NEXT_PUBLIC_SOLANA_CLUSTER: string;
	NEXT_PUBLIC_SOLANA_RPC_URL: string;
	NEXT_PUBLIC_API_BASE_URL: string;
	POLICY_SESSION_SECRET: string;
	NEXT_PUBLIC_TOP_UP_ACCUMULATOR: string;
	NEXT_PUBLIC_SECURE_SIGNER_ORIGIN: string;
	WORKER_SELF_REFERENCE: Fetcher /* revibase-app */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_APP_URL" | "NEXTJS_ENV" | "NEXT_PUBLIC_SOLANA_CLUSTER" | "NEXT_PUBLIC_SOLANA_RPC_URL" | "NEXT_PUBLIC_API_BASE_URL" | "POLICY_SESSION_SECRET" | "NEXT_PUBLIC_TOP_UP_ACCUMULATOR" | "NEXT_PUBLIC_SECURE_SIGNER_ORIGIN">> {}
}
