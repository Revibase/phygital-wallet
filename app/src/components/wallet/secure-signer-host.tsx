  ...
  return (
    ...
    >
      <SheetContent
        ...
        className="z-60 gap-0 overflow-hidden rounded-t-3xl border-0 bg-background p-0 shadow-[0_-8px_40px_oklch(0.234_0.008_182/0.18)] sm:max-w-100 sm:rounded-3xl sm:shadow-[0_20px_60px_oklch(0.234_0.008_182/0.18)]"
      >
