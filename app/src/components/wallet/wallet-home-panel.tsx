...
export const WalletHomePanel = memo(function WalletHomePanel({
  portfolio,
  loading,
  onSend,
  onSendAsset,
  ...
  return (
    <div className={cn("flex flex-1 flex-col gap-6", galleryAnimate.rise, className)}>
      <div className="flex flex-col items-center gap-1.5 py-1 text-center lg:items-start lg:text-left">
        <h1 className="text-balance-hero tabular-nums">{heroValue}</h1>
        {empty ? (
          <Button
            type="button"
            variant="link"
      ...
      <div className="mx-auto flex w-full max-w-xl items-center justify-center gap-3 px-2 lg:hidden">
        <Button
          type="button"
          size="lg"
...
function QuietNotice({
  ...
  if (!action || !onClick) {
    return (
      <div className="rounded-2xl bg-muted/20 px-4 py-2.5">
