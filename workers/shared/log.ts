...
function summarizeResult(result: unknown): LogFields {
  ...
  if (typeof r.notified === "number") summary.notified = r.notified;
  if (typeof r.recorded === "boolean") summary.recorded = r.recorded;
  if (typeof r.resolved === "boolean") summary.resolved = r.resolved;
